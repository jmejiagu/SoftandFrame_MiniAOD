...
process.rootuple = cms.EDAnalyzer('JPsiV0',
                          ...
                          ##Trk1mass      = cms.double(0.938272),
                          Trk1mass      = cms.double(0.13957018),
                          Trk2mass      = cms.double(0.13957018),       
                          #v0mass      = cms.double(1.115683),
                          v0mass      = cms.double(0.497614),
                          #TrkTrkMasscut     = cms.vdouble(1.0856,1.145683),                                                  
                          TrkTrkMasscut     = cms.vdouble(0.450,0.550),
                          bMasscut          = cms.vdouble(5.0,6.0),           
                          )

process.TFileService = cms.Service("TFileService",
        fileName = cms.string('Rootuple_PsiV0_Bd_toJpsipipi_2018UL_MiniAOD.root'),
)
